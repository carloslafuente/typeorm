    ...
    it("all types should work correctly - persist and hydrate", () =>
        Promise.all(
            dataSources.map(async (dataSource) => {
                ...
                loadedPost.uniqueidentifier.should.be.equal(
                ...
                loadedPost.binary
                    .toString()
                    .should.be.equal(post.binary.toString())
                loadedPost.varbinary
                    .toString()
                    .should.be.equal(post.varbinary.toString())
                loadedPost.image
                    .toString()
                    .should.be.equal(post.image.toString())
                ...
                loadedPost.smalldatetime
                    .getTime()
                    .should.be.equal(post.smalldatetime.getTime())
                loadedPost.timeObj.should.be.equal(
                    DateUtils.mixedTimeToString(post.timeObj),
                )
                ...
                loadedPost.simpleJson.param.should.be.equal(
                    post.simpleJson.param,
                )
                ...
                table!
                    .findColumnByName("smallmoney")!
                    .type.should.be.equal("smallmoney")
                table!.findColumnByName("money")!.type.should.be.equal("money")
                table!
                    .findColumnByName("uniqueidentifier")!
                ...
                table!
                    .findColumnByName("binary")!
                    .type.should.be.equal("binary")
                table!
                ...
                table!
                    .findColumnByName("datetime2")!
                    .type.should.be.equal("datetime2")
                table!
                    .findColumnByName("smalldatetime")!
                    .type.should.be.equal("smalldatetime")
                table!.findColumnByName("time")!.type.should.be.equal("time")
                table!.findColumnByName("timeObj")!.type.should.be.equal("time")
                table!
                    .findColumnByName("datetimeoffset")!
                    .type.should.be.equal("datetimeoffset")
                table!
                    .findColumnByName("geometry1")!
                ...
                table!
                    .findColumnByName("simpleEnum")!
                    .enum![0].should.be.equal("A")
                table!
                    .findColumnByName("simpleEnum")!
                    .enum![1].should.be.equal("B")
                table!
                    .findColumnByName("simpleEnum")!
                    .enum![2].should.be.equal("C")
                table!
                    .findColumnByName("simpleClassEnum1")!
                    .type.should.be.equal("nvarchar")
                table!
                    .findColumnByName("simpleClassEnum1")!
                    .enum![0].should.be.equal("apple")
                table!
                    .findColumnByName("simpleClassEnum1")!
                    .enum![1].should.be.equal("pineapple")
                table!
                    .findColumnByName("simpleClassEnum1")!
    ...
    it("all types should work correctly - persist and hydrate when options are specified on columns", () =>
        Promise.all(
            dataSources.map(async (dataSource) => {
                ...
                // loadedPost.datetime2.getTime().should.be.equal(post.datetime2.getTime());
                // loadedPost.datetimeoffset.getTime().should.be.equal(post.datetimeoffset.getTime());
                loadedPost.time.should.be.equal(
                    DateUtils.mixedTimeToString(post.time),
                )
    ...
    it("all types should work correctly - persist and hydrate when types are not specified on columns", () =>
        Promise.all(
            dataSources.map(async (dataSource) => {
                ...
                loadedPost.datetime
                    .getTime()
                    .should.be.equal(post.datetime.getTime())
